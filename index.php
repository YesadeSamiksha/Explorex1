...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['signup'])) {
        ...
        $feedback_query = "INSERT INTO feedbacks (name, email, mobile, message) VALUES ('$name', '$email', '$mobile', '$message')";

        if (mysqli_query($conn, $feedbacks_query)) {
...
<body>
    ...
    <section class="contact" id="contact">
        <h2 class="heading">Feedback</h2>
         ...
         <form id="feed-back " class="feed-back" action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
